...
def generate_vrt(json_file, output_vrt):
    ...
    for chunk in chunks:
        ...
        if not os.path.exists(img_path):
            # print(
            #     f"Image file does not exist, using transparent image instead: {img_path}"
            # )
            img_filename = "chunk57.png"
...
# python ./gdal2tiles-multiprocess.py -l -p raster -r near -z 0-2 -e -v /Users/nmurray/projects/crypto/forgotten-runes-private/forgotten-marketplace-v2/public/maps/runiverse-sketch/output_map.vrt mapchunks
